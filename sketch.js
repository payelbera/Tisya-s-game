...
resetBtn = createButton("Try Again")
resetBtn.position(850,450)
...
function checkAnswer(){
  console.log("x1:"+puzzle1.x+"y:"+puzzle1.y)
  console.log("x2:"+puzzle2.x+"y:"+puzzle2.y)
  console.log("x3:"+puzzle3.x+"y:"+puzzle3.y)
  console.log("x4:"+puzzle4.x+"y:"+puzzle4.y)
  console.log("x5:"+puzzle5.x+"y:"+puzzle5.y)
  console.log("x6:"+puzzle6.x+"y:"+puzzle6.y)
  console.log("x7:"+puzzle7.x+"y:"+puzzle7.y)
  
  if(puzzle7.x>655 && puzzle7.x<715 && puzzle7.y>110 && puzzle7.y<160){
answer7 = true
      ...
      // console.log("check3"+answer3)
          ...
          if(puzzle4.x>975 && puzzle4.x<1020 && puzzle4.y>110 && puzzle4.y<160){
           ...
           // console.log("check4"+answer4)
              ...
              if(puzzle5.x>655 && puzzle5.x<715 && puzzle5.y>215 && puzzle5.y<265){
                answer5 = true
